...
<head>
    <title>后台</title>
    <link href="<?= $this->url->getStatic('admin/css/theme.min.css') ?>" rel="stylesheet">
    <link href="<?= $this->url->getStatic('default/font-awesome/4.4.0/css/font-awesome.min.css') ?>" rel="stylesheet">
    <link href="<?= $this->url->getStatic('admin/css/simplebootadminindex.min.css') ?>" rel="stylesheet">
    <style>
...
<div class="navbar">
    <div class="navbar-inner">
        ...
        <div class="container-fluid">
            ...
            <a href="<?= $this->url->get('backend/index/index') ?>" class="brand">
                <small>后台管理中心</small>
            </a>
            ...
            <ul class="nav simplewind-nav pull-right">
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" width="30" height="30" src="<?= $this->url->getStatic('admin/images/logo-18.png') ?>"
                             alt="admin">
...
<div class="main-container container-fluid">
    ...
    <div class="main-content">
        ...
        <div class="page-content" id="content">
            <iframe src="<?= $this->url->get('backend/index/main') ?>" style="width:100%;height: 100%;" frameborder="0"
                    id="appiframe-0" class="appiframe"></iframe>
        </div>
    </div>
</div>
<script src="<?= $this->url->getStatic('admin/js/jquery.min.js') ?>"></script>

<script src="<?= $this->url->getStatic('admin/js/bootstrap.min.js') ?>"></script>
<script src="<?= $this->url->getStatic('admin/js/index.js') ?>"></script>
<script src="<?= $this->url->getStatic('admin/js/jquery-1.8.0.min.js') ?>"></script>
<script>
